...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new rocks.outdatedguy.receive_sharing_intent_plus.ReceiveSharingIntentPlusPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin receive_sharing_intent_plus, rocks.outdatedguy.receive_sharing_intent_plus.ReceiveSharingIntentPlusPlugin", e);
    }
    try {
